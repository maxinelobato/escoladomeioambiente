        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="group flex h-full flex-col rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            <div className="mt-auto flex divide-x divide-gray-200 border-t border-gray-200">
              <a
                className="inline-flex w-full items-center justify-center gap-x-2 rounded-es-xl bg-white px-4 py-3 text-sm font-medium text-gray-800 shadow-sm hover:bg-gray-50 disabled:pointer-events-none disabled:opacity-50"
                href="#"
              >
                View sample
              </a>
              <a
                className="inline-flex w-full items-center justify-center gap-x-2 rounded-ee-xl bg-white px-4 py-3 text-sm font-medium text-gray-800 shadow-sm hover:bg-gray-50 disabled:pointer-events-none disabled:opacity-50"
                href="#"
              >
                View API
              </a>
          ...
          <div className="group flex h-full flex-col rounded-xl border border-gray-200 bg-white shadow-sm">
            <div className="flex h-52 flex-col items-center justify-center rounded-t-xl bg-rose-500">
              <svg
                className="size-28"
                width="56"
                height="56"
          ...
          <div className="group flex h-full flex-col rounded-xl border border-gray-200 bg-white shadow-sm">
            <div className="flex h-52 flex-col items-center justify-center rounded-t-xl bg-amber-500">
              <svg
                className="size-28"
                width="56"
                height="56"
            ...
            <div className="p-4 md:p-6">
              <span className="mb-1 block text-xs font-semibold uppercase text-amber-500">
                Slack API
              </span>
