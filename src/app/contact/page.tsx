...
export default function Home() {
  return (
    <>
      <div className="relative bg-gradient-to-br from-blue-100 via-transparent">
        <div className="-top-40 mx-auto mt-20 max-w-screen-xl px-4 py-0 pb-10 sm:px-2 sm:py-10">
          <div className="mx-auto max-w-screen-xl px-4 py-10 sm:px-0 lg:py-14">
            <div className="grid items-center gap-8 md:grid-cols-2 lg:gap-12">
              <div>
                ...
                <div className="mt-4 max-w-2xl md:mb-12">
                  <h1 className="mb-4 text-4xl font-semibold text-gray-800 lg:text-5xl">
                ...
                <blockquote className="relative hidden max-w-sm md:block">
                  <svg
                    className="absolute start-0 top-0 size-16 -translate-x-6 -translate-y-8 transform text-gray-200"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
              ...
              <div>
                <div className="ms-auto lg:mx-auto lg:me-0 lg:max-w-lg">
                  <div className="flex flex-col rounded-2xl bg-white/30 p-4 shadow-lg backdrop-blur-2xl sm:p-7">
            ...
            <div className="mt-6 flex items-center gap-x-1.5 py-3 text-sm text-gray-800 after:ms-6 after:flex-1 after:border-t after:border-gray-200 md:mt-12">
              <span className="bg-gradient-to-l from-blue-600 to-violet-500 bg-clip-text font-semibold text-transparent">
                50,000
              </span>
            ...
            <div className="flex flex-wrap gap-x-6 sm:gap-x-12 lg:gap-x-24">
              <svg
                className="h-auto w-16 py-3 text-gray-500 md:w-20 lg:w-24 lg:py-5"
